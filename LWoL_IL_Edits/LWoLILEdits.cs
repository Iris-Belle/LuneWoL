...
public partial class LWoLILEdits
{
    ...
    {
        LWoLServerConfig.NPCsDented npc = LuneWoL.LWoLServerConfig.NPCs;
        LWoLServerConfig.EquipmentDented equip = LuneWoL.LWoLServerConfig.Equipment;
        LWoLServerConfig.TilesDented tiles = LuneWoL.LWoLServerConfig.Tiles;
    ...
    {
        LWoLAdvancedServerSettings.OreDensityDented Acfg = LuneWoL.LWoLAdvancedServerSettings.OreDensityCfg;
        ...
        if (c.TryGotoNext(MoveType.After,
            ...
            i => i.MatchStloc2()))
        {
            _ = c.Emit(OpCodes.Ldloc_2);
            _ = c.Emit(OpCodes.Ldc_R8, (double)Acfg.HardmodeOreDensityPercent / 100);
            _ = c.Emit(OpCodes.Mul);
            _ = c.Emit(OpCodes.Stloc_2);
        }
        if (c.TryGotoNext(MoveType.Before, i => i.MatchLdcI4(5)))
        {
            _ = c.RemoveRange(2);
            _ = c.Emit(OpCodes.Ldc_I4, scaledMin);
            _ = c.Emit(OpCodes.Ldc_I4, scaledMaxAnniversary);
        }
        if (c.TryGotoNext(MoveType.Before, i => i.MatchLdcI4(5)))
        {
            _ = c.RemoveRange(2);
        ...
        if (c.TryGotoNext(MoveType.Before, i => i.MatchLdcI4(5)))
        {
            _ = c.RemoveRange(2);
            _ = c.Emit(OpCodes.Ldc_I4, scaledMin);
            _ = c.Emit(OpCodes.Ldc_I4, scaledMaxDefault);
        }
        if (c.TryGotoNext(MoveType.Before, i => i.MatchLdcI4(5)))
        {
            _ = c.RemoveRange(2);
    ...
    private static void BuyPriceandSellPrice(ILContext il)
    {
        ...
        {
            _ = c.RemoveRange(4);
            _ = c.Emit(OpCodes.Ldc_R4, npc.BuyMult);
            _ = c.Emit(OpCodes.Conv_R8);
            _ = c.Emit(OpCodes.Mul);
        }
        if (c.TryGotoNext(MoveType.Before, i => i.MatchLdarg(0), i => i.MatchLdflda<Player>("currentShoppingSettings")))
        {
            _ = c.RemoveRange(4);
            _ = c.Emit(OpCodes.Ldc_R4, npc.SellMult);
            _ = c.Emit(OpCodes.Conv_R8);
            _ = c.Emit(OpCodes.Mul);
        }
        if (c.TryGotoNext(MoveType.Before, i => i.MatchLdarg(0), i => i.MatchLdflda<Player>("currentShoppingSettings")))
    ...
    private static void NerfAccessoryReforges(ILContext iL)
    {
        ...
        {
            _ = c.Remove();
            _ = c.Emit(OpCodes.Ldc_I4, 1);
        }
        if (c.TryGotoNext(MoveType.Before, i => i.MatchLdcI4(3)))
        {
            _ = c.Remove();
            _ = c.Emit(OpCodes.Ldc_I4, 2);
        }
